...
class ConformerBlock(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.conv1=DepthWiseConv1d(dim, dim, conv_kernel_size, padding=calc_same_padding(conv_kernel_size))
